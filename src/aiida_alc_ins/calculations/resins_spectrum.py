...
class Resins(BaseINS):
    ...
    DEFAULT_INPUT_FILE = "tosca-spectrum.json"
    RESINS_OUTPUT = "resins-spectra.json"
    ...
    def define(cls, spec: CalcJobProcessSpec) -> None:
        ...
        spec.input(
            ...
            valid_type=Str,
            required=True,
            default=lambda: Str("tosca-spectra.json"),
        ...
        spec.input(
            ...
            valid_type=Str,
            required=False,
            default=lambda: Str(cls.RESINS_OUTPUT),
        ...
        spec.input(
            ...
            valid_type=Str,
            required=False,
            default=lambda: Str("TOSCA"),
            help="Name of the instrument to use for resolution function.",
        )
        spec.inputs["metadata"]["options"]["parser_name"].default = "abinslib.resins_parser"
        ...
        spec.output("resins_output", valid_type=SinglefileData)
    ...
    def prepare_for_submission(
        ...
        if self.inputs.instrument.value != "TOSCA":
            cmdline_params.extend(["--instrument", self.inputs.instrument.value])
